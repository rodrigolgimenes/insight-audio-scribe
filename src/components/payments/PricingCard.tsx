...
export const PricingCard = ({
  ...
  const isYearlyPlan = priceId === 'prod_Rlb6RWk7O8GE6M';
    ...
    >
      ...
      <CardFooter>
        <Button
          ...
          disabled={hasActiveSubscription && priceId !== 'prod_Rlb6RWk7O8GE6M'}
          size="lg"
        >
          {hasActiveSubscription && priceId !== 'prod_Rlb6RWk7O8GE6M' 
            ? 'Already Subscribed' 
            : buttonText}
        </Button>
      </CardFooter>
